					...
					<div className='w-full'>
						...
						{!loading && currentProblem && (
							<div className='flex items-center mt-3'>
								<div
									className={`${problemDifficultyClass} inline-block rounded-[21px] bg-opacity-[.15] px-2.5 py-1 text-xs font-semibold capitalize`}
								>
						...
						<div className='text-white text-sm'>
							<div dangerouslySetInnerHTML={{ __html: problem.question }} className="grid gap-2 mt-3"/>
						</div>
						...
						<div className='my-8 pb-4'>
							...
							<ul className='text-white ml-5 list-disc '>
								<div dangerouslySetInnerHTML={{ __html: problem.constaints }} className="grid gap-2 mt-3"/>
							</ul>
						</div>
					</div>
				</div>
